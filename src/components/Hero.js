...
const Hero = () => {
  ...
  return (
    <div className='relative z-40 wow animate__animated animate__zoomIn w-full bg-cover bg-no-repeat bg-center h-[450px] md:h-[320px]' style={{ backgroundImage: `url(${hero})` }}>
      <Container>
