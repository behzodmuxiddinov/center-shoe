            ...
            <ReactCardFlip flipDirection='vertical' isFlipped={recover}>
                <div className='w-full'>
                    ...
                    <form className='w-full flex flex-col' onChange={() => dispatch(removeLoginFail())} onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <button onClick={showrecover} className={`bg-transparent border-none cursor-pointer w-max font-semibold ${light ? 'text-gray-600 hover:text-gray-700' : 'text-white'}`}>{t("forget")}</button>
